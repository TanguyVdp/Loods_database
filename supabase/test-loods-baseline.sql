...
-- Supabase SQL Editor als je de wachtrij-test wil proberen. Als je dit al
-- eerder gerund had (voor de vorige testversie), mag je het gewoon opnieuw
-- runnen — alles gebruikt "if not exists" / "on conflict", dus onschadelijk.
-- ============================================================
