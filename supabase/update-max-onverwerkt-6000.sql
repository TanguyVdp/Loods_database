-- ============================================================
-- Wietloods — update: max onverwerkt van 5.000 naar 6.000 planten
--
-- Zelfde regel als in update-max-onverwerkt-5000.sql, enkel de grens omhoog:
-- iedereen mag nu tot 6.000 planten "momenteel inleg" (nog niet door de
-- wachtrij verwerkt) tegelijk hebben liggen i.p.v. 5.000. Verder ongewijzigd
...
--
-- Voer dit EENMALIG uit in de Supabase SQL Editor, na update-max-onverwerkt-5000.sql.
-- ============================================================
